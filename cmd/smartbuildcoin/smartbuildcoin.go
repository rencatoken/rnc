...
var (
	...
	logFormat  = "[smartbuildcoin.%{module}:%{level}] %{message}"
	logModules = []string{
		"main",
		"daemon",
		"coin",
	...
	GenesisSignatureStr = "6e9fdd4a39bfcbc52611e5ec99617586b0f5e6d17653f11cd7d00e101b7e47115c09b75fe9e88197d5ad59480dea80eca72506a50be7f5b683d3b4c62703de1d01"
	// GenesisAddressStr genesis address string
	GenesisAddressStr = "2fr63Rv2HS3cH8LgtXPPMgzXAXh6a1QbUpm"
	// BlockchainPubkeyStr pubic key string
	BlockchainPubkeyStr = "02eac85eef94f8057505b038842b0b380f6bbc6b4577facf339130e48eafd2e16d"
	// BlockchainSeckeyStr empty private key string
	BlockchainSeckeyStr = ""

	// GenesisTimestamp genesis block create unix time
	GenesisTimestamp uint64 = 1513095542
...
type Config struct {
	...
	// Data directory holds app data -- defaults to ~/.smartbuildcoin
...
func (c *Config) register() {
	...
	flag.StringVar(&c.DataDirectory, "data-dir", c.DataDirectory,
		"directory to store app data (defaults to ~/.smartbuildcoin)")
	...
	flag.StringVar(&c.WalletDirectory, "wallet-dir", c.WalletDirectory,
		"location of the wallet files. Defaults to ~/.smartbuildcoin/wallet/")
...
var devConfig = Config{
	...
	RPCInterface:     true,
	RPCInterfacePort: 8130,
	RPCInterfaceAddr: "127.0.0.1",
	RPCThreadNum:     5,

	LaunchBrowser: true,
	// Data directory holds app data -- defaults to ~/.smartbuildcoin
	DataDirectory: ".smartbuildcoin",
	...
	ProfileCPU: false,
	// Where the file is written to
	ProfileCPUFile: "smartbuildcoin.prof",
	// HTTP profiling interface (see http://golang.org/pkg/net/http/pprof/)
	HTTPProf: false,
	// Will force it to connect to this ip:port, instead of waiting for it
	// to show up as a peer
...
// Run starts the smartbuildcoin node
func Run(c *Config) {
	defer func() {
	...
	if c.WebInterface {
		...
		if c.WebInterfaceHTTPS {
			...
			errs := cert.CreateCertIfNotExists(host, c.WebInterfaceCert, c.WebInterfaceKey, "Smartbuildcoind")
			if len(errs) != 0 {
...
func InitTransaction() coin.Transaction {
	...
	output := cipher.MustSHA256FromHex("b25ea0b8058cebe9787a9a93fbb68d2d02a71d3fb4eaf5d45736d05aee52f204")
	tx.PushInput(output)
	...
	if visor.DistributionAddressInitialBalance != 3e6 {
		log.Panic("visor.DistributionAddressInitialBalance expected to be 3e6*1e6")
	}
